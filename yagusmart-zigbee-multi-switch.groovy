...
metadata {
	definition(name: "Yagusmart Zigbee Multi Switch", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.switch", mnmn: "SmartThings", vid: "generic-switch") {
		capability "Actuator"
		...
		fingerprint profileId: "0104", inClusters: "0000, 0005, 0004, 0006", outClusters: "0000", manufacturer: "_TZ3000_fvh3pjaz", model: "TS0012", deviceJoinName: "Yagusmart 2 Gang Switch" //Yagusmart 2 Gang Switch
		fingerprint profileId: "0104", inClusters: "0000, 0005, 0004, 0006", outClusters: "0000", manufacturer: "_TYZB01_xiuox57i", model: "TS0013", deviceJoinName: "Yagusmart 3 Gang Switch" //Yagusmart 3 Gang Switch
...
private Boolean isYagu() {
	...
	//device.getDataValue("manufacturer")  == "_TYZB01_xiuox57i"
}

private getChildCount() {
	if (device.getDataValue("model") == "TS0012") {
		return 2
	} else if (device.getDataValue("model") == "TS0013") {
		return 3
	}
}