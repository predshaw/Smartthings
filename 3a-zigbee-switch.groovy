/*
 *  3A Smart Home ZigBee Switch - touch
 * 
 ...
 *  under the License.
 *
 *  Modified version of Zemi ZigBee Switch - touch from fuls@naver.com
 *
 *	author: all.mac07@gmail.com
 */
...
metadata {
    definition(name: "3A ZigBee Switch", namespace: "3A", author: "Alberto", ocfDeviceType: "oic.d.switch", vid: "generic-switch") {
        capability "Actuator"
        ...
        // 3A ZigBee Multi Switch
        
        fingerprint endpointId: "0B", profileId: "C05E", inClusters: "0000, 0004, 0003, 0006, 0005, 1000, 0008", outClusters: "0019", manufacturer: "3A Smart Home DE", model: "LXN-1S27LX1.0", deviceJoinName: "3A Zigbee 1 Touch Switch"
        fingerprint endpointId: "01", profileId: "C05E", inClusters: "0000, 0004, 0003, 0006, 0005, 1000, 0008", outClusters: "0019", manufacturer: "3A Smart Home DE", model: "LXN-3S27LX1.0", deviceJoinName: "3A Zigbee 1 Touch Switch"
        fingerprint endpointId: "0B", profileId: "C05E", inClusters: "0000, 0004, 0003, 0006, 0005, 1000, 0008", outClusters: "0019", manufacturer: "3A Smart Home DE", model: "LXN-2S27LX1.0", deviceJoinName: "3A Zigbee 2 Touch Switch" }
...
def installed() {
    ...
    if (endpointCount == 1) {
        ...
        if (model == 'LXN-2S27LX1.0') {
            device.updateDataValue("endpointId", "0B")
        }
